...
gulp.task("css", gulp.series(cleanTasks.css, "sass-compile", autoPrefixTasks.css, cssTasks.css_comb, cssTasks.css_min));
...
gulp.task("dist", gulp.parallel("css", "dist-js"));

gulp.task("default", gulp.parallel("css", "dist-js"));
